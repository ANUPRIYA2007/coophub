...
const DIRECT_CATALOG_ALIAS = {
  ...
  "unified cooperative service ecosystem": "landing.badge",
  "landing.badge": "landing.badge",
  "select your portal to get started": "landing.title",
  "landing.title": "landing.title",
  "dedicated authenticated portals designed for customers, certified pillar technicians, and cooperative administrators.": "landing.subtitle",
  "dedicated authenticated portals designed for customers, certified pillar technicians, and cooperative administrators": "landing.subtitle",
  "landing.subtitle": "landing.subtitle",
  "consumers": "landing.consumers",
  "landing.consumers": "landing.consumers",
  "customer portal": "landing.customerPortal",
  "landing.customerportal": "landing.customerPortal",
  "book verified home services with real-time gps tracking, otp arrival verification, extra charge approval, and ai assistance.": "landing.customerDesc",
  "book verified home services with real-time gps tracking, otp arrival verification, extra charge approval, and ai assistance": "landing.customerDesc",
  "landing.customerdesc": "landing.customerDesc",
  "customer login (email / otp)": "landing.customerLogin",
  "customer login (email/otp)": "landing.customerLogin",
  "customer login": "landing.customerLogin",
  "landing.customerlogin": "landing.customerLogin",
  "new customer? register": "landing.customerRegister",
  "landing.customerregister": "landing.customerRegister",
  "service partners": "landing.servicePartners",
  "landing.servicepartners": "landing.servicePartners",
  "pillar portal": "landing.pillarPortal",
  "landing.pillarportal": "landing.pillarPortal",
  "manage incoming bookings, verify doorstep otp, chat with customers, request extra charges, and track cooperative earnings.": "landing.pillarDesc",
  "manage incoming bookings, verify doorstep otp, chat with customers, request extra charges, and track cooperative earnings": "landing.pillarDesc",
  "landing.pillardesc": "landing.pillarDesc",
  "pillar login (id + otp)": "landing.pillarLogin",
  "pillar login (id/otp)": "landing.pillarLogin",
  "pillar login": "landing.pillarLogin",
  "landing.pillarlogin": "landing.pillarLogin",
  "register as a pillar partner": "landing.pillarRegister",
  "landing.pillarregister": "landing.pillarRegister",
  "cooperative authority": "landing.coopAuthority",
  "landing.coopauthority": "landing.coopAuthority",
  "admin portal": "landing.adminPortal",
  "landing.adminportal": "landing.adminPortal",
  "platform administration, verify and approve pillars, manage service catalogue, audit live orders, and inspect welfare finance.": "landing.adminDesc",
  "platform administration, verify and approve pillars, manage service catalogue, audit live orders, and inspect welfare finance": "landing.adminDesc",
  "landing.admindesc": "landing.adminDesc",
  "admin login (id + otp)": "landing.adminLogin",
  "admin login (id/otp)": "landing.adminLogin",
  "admin login": "landing.adminLogin",
  "landing.adminlogin": "landing.adminLogin",
  "internal access only (no registration)": "landing.internalOnly",
  "internal access only": "landing.internalOnly",
  "landing.internalonly": "landing.internalOnly",
  "connect | serve | empower. all rights reserved.": "landing.footer",
  "connect | serve | empower. all rights reserved": "landing.footer",
  "landing.footer": "landing.footer",

  // Mascot & Hero Assistant
  "coopbot live guide": "mascot.liveGuide",
  "mascot.liveguide": "mascot.liveGuide",
  "tap to chat with ai": "mascot.tapToChat",
  "mascot.taptochat": "mascot.tapToChat",
  "ask anything →": "mascot.askAnything",
  "ask anything": "mascot.askAnything",
  "mascot.askanything": "mascot.askAnything",
  "ask coopbot ai": "mascot.askCoopBot",
  "mascot.askcoopbot": "mascot.askCoopBot",
  "how can i assist your home today?": "mascot.greeting",
  "how can i assist your home today": "mascot.greeting",
  "coopbot: idle": "mascot.statusIdle",
  "coopbot: speaking": "mascot.statusSpeaking",
  "coopbot: thinking": "mascot.statusThinking",
  "coopbot": "app.name",
  ...
  "history": "nav.history",
  "navigation.history": "nav.history",
  "completed services": "nav.history",
  "history.title": "nav.history",
  "service history": "nav.history",
  "nav.history": "nav.history",
  "support": "nav.support",
  "help & support": "nav.support",
  "help and support": "nav.support",
  "help": "nav.support",
  "support.title": "nav.support",
