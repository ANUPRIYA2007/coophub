        ...
        <div className="min-h-screen bg-surface pb-24 pt-6 px-4">
            <div className="max-w-xl mx-auto">
                <div className="flex items-center mb-8">
                    ...
                    <h1 className="heading-3">{t('Create Support Ticket')}</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-3xl border border-navy-100 shadow-sm space-y-5">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-navy-700 mb-2">{t('Subject (Required)')}</label>
                        <input
                            type="text"
                            required
                            maxLength={100}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-navy-700 mb-2">{t('Category')}</label>
                        <select
                            value={category}
                        ...
                        >
                            ...
                            <option value="service_issue">{t('Service Issue')}</option>
                            <option value="billing">{t('Billing & Payment')}</option>
                            <option value="feedback">{t('Feedback / Suggestion')}</option>
                        </select>
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-navy-700 mb-2">{t('Description (Required)')}</label>
                        <textarea
                            required
                            value={description}
                            onChange={(e) => setDescription(e.target.value)}
                            className="input-field w-full h-32 resize-none"
                            placeholder={t("Please provide details to help us resolve this faster...")}
                        ></textarea>
                    </div>
