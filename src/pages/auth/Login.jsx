            ...
            >
                ...
                <div style={{ flex: 1.1, display: "flex", justifyContent: "center" }} className="hidden md:flex">
                    <CustomerHeroInteractiveAgent
                        ...
                        formError={error}
                        formSuccess={Boolean(successMsg)}
                    />
                </div>

                {/* Right: Login Card */}
                <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
                    <div className="card max-w-md w-full p-8 shadow-2xl mt-8 sm:mt-0 relative overflow-hidden bg-white rounded-3xl border border-navy-100">
