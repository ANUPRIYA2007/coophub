...
import { ShoppingBag, Wrench, Shield, ArrowRight, Sparkles, CheckCircle2, UserPlus, LogIn, Lock } from 'lucide-react';
...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-navy-950 to-slate-900 text-white relative overflow-hidden flex flex-col justify-between">
            ...
            <main className="max-w-6xl mx-auto px-6 py-8 flex-1 flex flex-col justify-center relative z-10 w-full">
                <div className="text-center mb-10 max-w-3xl mx-auto">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-xs font-semibold uppercase tracking-wider mb-4 shadow-inner">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto w-full">
                    ...
                    {/* 1. Customer Portal */}
                    <div className="bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-orange-500/40 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:shadow-orange-500/10 group">
                        <div>
                        ...
                        <div className="space-y-2.5 pt-4 border-t border-white/10">
                            <button
                                ...
                                className="w-full py-3 px-4 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 transition-all"
                            >
                                <LogIn size={15} />
                            ...
                            <button
                                ...
                                className="w-full py-2.5 px-4 rounded-xl bg-white/5 hover:bg-white/10 text-navy-200 hover:text-white border border-white/10 font-semibold text-xs flex items-center justify-center gap-2 transition-all"
                            >
                                <UserPlus size={14} />
                    ...
                    <div className="bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-blue-500/40 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:shadow-blue-500/10 group">
                        <div>
                        ...
                        <div className="space-y-2.5 pt-4 border-t border-white/10">
                            <button
                                ...
                                className="w-full py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20 transition-all"
                            >
                                <LogIn size={15} />
                    ...
                    <div className="bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-amber-500/40 rounded-3xl p-7 transition-all duration-300 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:shadow-amber-500/10 group">
                        <div>
                        ...
                        <div className="space-y-2.5 pt-4 border-t border-white/10">
                            <button
                                ...
                                className="w-full py-3 px-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-navy-950 font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 transition-all"
                            >
                                <Lock size={15} />
