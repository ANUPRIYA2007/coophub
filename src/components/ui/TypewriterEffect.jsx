...
export default function TypewriterEffect(props) {
  ...
  useEffect(() => {
    ...
    if (!isDeleting && charIndex < currentWord.length) {
      ...
      if (!loop) {
        // If loop is disabled, stop typing animation and keep the completed text visible
        return;
      }
  ...
  }, [charIndex, isDeleting, pause, wordIndex, currentWord, typingSpeed, deletingSpeed, pauseDuration, words.length, loop]);
  ...
  const fontSize = useMemo(() => {
    ...
    return 16; // default fallback font size
  }, [font]);
