...
export default function ChatAgent({ onClose, contextData }) {
        ...
        try {
            const res = await fetch('http://localhost:3000/api/ai/chat', {
                ...
                body: JSON.stringify({
                    messages: newHistory,
                    language,
                    catalogContext: contextData // Real catalogue data stringified
                })
            });
    ...
    return (
        <div className="fixed bottom-4 right-4 w-80 sm:w-96 bg-surface shadow-2xl rounded-2xl border border-navy-100 flex flex-col overflow-hidden z-50">
            {/* Header */}
